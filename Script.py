...
<b><spoiler>🔋 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - <a href=https://t.me/looterekrish>Lₒₒ𝚝ₑᵣₑ™</b></spoiler></a>"""
...
‣ ᴄʀᴇᴀᴛᴏʀ : <a href=https://t.me/looterekrish>Lₒₒ𝚝ₑᵣₑ™</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ʜᴇʀᴏᴋᴜ
...
★ Mᴇssᴀɢᴇ <code>{}</code>"""
    ...
    CAPTION = """
<b>📂 Fɪʟᴇ ɴᴀᴍᴇ : <b>[@RKMOVIESZIP] {file_name}

<blockquote>✅ 𝘼𝙡𝙨𝙤 𝙟𝙤𝙞𝙣 #𝙍𝙠𝙢𝙤𝙫𝙞𝙚𝙯𝙞𝙥 – #𝙉𝙤𝟏 𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙈𝙤𝙫𝙞𝙚𝙨 𝘼𝙣𝙙 𝙒𝙚𝙗 𝙎𝙚𝙧𝙞𝙚𝙨 𝙀𝙣𝙩𝙚𝙧𝙩𝙖𝙞𝙣𝙢𝙚𝙣𝙩 𝘾𝙝𝙖𝙣𝙣𝙚𝙡. </blockquote>

⏤‌‌𝗝⌡𝗼𝗶𝗻 𝗣𝗥𝗘𝗠𝗜𝗨𝗠  –「 @RKMOVIESZIP 」🔥</b>"""
...
🌟 Rating: <a href={url}/ratings>{rating}</a> / 10</b> """
    ...
    CHANNELS = """
<b>ᴊᴏɪɴ ᴛʜɪs ᴄʜᴀɴɴᴇʟ ғᴏʀ movies ᴜᴘᴅᴀᴛᴇs </b>"""
...
💵 ᴜᴘɪ ɪᴅ - <code>paytmqr5tuep5@ptys</code>
