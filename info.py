...
BOT_TOKEN = environ.get('BOT_TOKEN', "7057950290:AAG_8qBmZCDMqjyCik2kiWBFnDbSoKUyBm0")
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002263971223'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002263971223))
